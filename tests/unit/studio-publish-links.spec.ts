...
describe('Studio published links', () => {
  ...
  it('routes release and embed query links to sibling applications', () => {
    expect(
      ...
      'https://urashima.github.io/Kyxos-Render/preview/pr-18/public/?release=v1',
    );
    expect(
      normalizeStudioPublishedUrl(
      ...
      'https://urashima.github.io/Kyxos-Render/preview/pr-18/embed/?release=v2&ui=0',
    );
  });
  ...
  it('converts canonical slug paths into static-host compatible queries', () => {
    expect(
      ...
      'https://urashima.github.io/Kyxos-Render/preview/pr-18/public/?slug=material-study',
    );
    expect(
      normalizeStudioPublishedUrl(
      ...
      'https://urashima.github.io/Kyxos-Render/preview/pr-18/public/?slug=material-study&release=version-3',
    );
  });
